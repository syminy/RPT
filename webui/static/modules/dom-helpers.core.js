// Extracted pure DOM helper functions (CommonJS + attach to window for browser usage)
(function(exports){
      ...
      while(node && node !== root){
        ...
        if (action) {
          try {
            ...
            } else if (typeof window !== 'undefined' && window.rptActions) {
...
})(typeof exports === 'undefined' ? (this['domHelpersCore']={}) : exports);
